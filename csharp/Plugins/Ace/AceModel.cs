...
namespace AceStdio.Model
{
    ...
    public class AceParams
    {
        ...
        [JsonProperty("realBreathiness")] public List<AceParamCurve> RealBreath { get; set; } = new List<AceParamCurve>();

        [JsonProperty("realTension")] public List<AceParamCurve> RealTension { get; set; } = new List<AceParamCurve>();

        [JsonProperty("realFalsetto")] public List<AceParamCurve> RealFalsetto { get; set; } = new List<AceParamCurve>();
