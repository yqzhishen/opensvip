...
namespace OpenSvip
{
    namespace Model
    {
                ...
                foreach (var track in model.TrackList)
                {
                    switch (track)
                    {
                        ...
                        case SingingTool.Model.InstrumentTrack instrumentalTrack:
                            TrackList.Add(new SingingTrack().Decode(instrumentalTrack));
                            break;
                    }
                }
                return this;
        ...
        public class Track
        {
            ...
            public Track Decode(SingingTool.Model.ITrack track)
            {
                Title = track.Name;
                Muted = track.Mute;
                Solo = track.Solo;
            ...
            public SingingTool.Model.ITrack Encode()
            {
        ...
        public class SingingTrack: Track
        {
            ...
            public new SingingTool.Model.SingingTrack Encode()
            {
        ...
        public class InstrumentalTrack: Track
        {
            ...
            public new SingingTool.Model.InstrumentTrack Encode()
            {
        ...
        public class Note
        {
            ...
            {
                var note = new SingingTool.Model.Note(StartPos, Length, KeyNumber, Lyric)
                {
