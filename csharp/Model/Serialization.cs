...
public class PointListJsonConverter : JsonConverter<List<Tuple<int, int>>>
{
    ...
    public override List<Tuple<int, int>> ReadJson(JsonReader reader, Type objectType, List<Tuple<int, int>> existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
